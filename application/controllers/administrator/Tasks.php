...
class Tasks extends CI_Controller {
	...
	public function ajaxListing(){
		...
		$indexColumn = 'tt.id';
		$selectColumns = ['tt.id','tt.task_title','tt.status','tu.first_name','tt.created_on'];
		$dataTableSortOrdering = ['tt.id','tt.task_title','tt.status','tu.first_name','tt.created_on'];
