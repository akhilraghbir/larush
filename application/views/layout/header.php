                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                            ...
                            <div data-simplebar style="max-height: 230px;">
                                ...
                                <a href="#" class="text-reset notification-item">
                                    <div class="d-flex">
                                        <img src="<?= base_url('assets/backend/');?>images/users/avatar-3.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="flex-1">
                                ...
                                <a href="#" class="text-reset notification-item">
                                    <div class="d-flex">
                                        <img src="<?= base_url('assets/backend/');?>images/users/avatar-4.jpg" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="flex-1">
