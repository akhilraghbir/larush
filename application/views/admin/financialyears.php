        ...
        <div class="">
            <div class="main-card mb-3 card card-body">
                ...
                if (isset($formData['id'])) {
                    $id = $formData['id'];
                    $url = CONFIG_SERVER_ADMIN_ROOT . "financialyears/edit/$id";
                } else {
                    $url = CONFIG_SERVER_ADMIN_ROOT . "financialyears/add";
                }
                echo form_open($url, array('class' => 'userRegistration', 'id' => 'userRegistration')); ?>

                <div class="form-row">
                    <div class="col-md-6">
                        <div class="position-relative form-group"><label for="first name" class="">Financial Year</label>
                            <input value="<?php if (isset($formData['financial_year'])) {
                                                echo $formData['financial_year'];
                                            } ?>" name="financial_year" id="financial_year" placeholder="Please Enter Financial Year" autocomplete='off' type="text" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
...
<script type="text/javascript">
    function getdata() {
        ...
        $('#userList').DataTable({
            ...
            "ajax": {
                "url": "<?php echo CONFIG_SERVER_ADMIN_ROOT ?>financialyears/ajaxListing",
                "type": 'POST',
                'data': {
                    status: status,
