<div class="col-md-12">
    ...
    <div class="main-card mb-3 card card-body">
        <h5 class="card-title"></h5>
            <?php
            $url = CONFIG_SERVER_ADMIN_ROOT . "settings/terms_and_conditions";
            echo form_open($url, array('class' => 'userRegistration', 'id' => 'userRegistration')); ?>
    
            <div class="form-row">
                <div class="col-md-12">
                    <div class="position-relative form-group"><label for="first name" class="">Terms And Conditions</label>
                            <textarea name="description_p"><?= $terms[0]['description'] ?></textarea>
                    </div>
                </div>
            </div>
